...
var base = new Airtable({ apiKey: "key6V1lXp0HHX40Iz" }).base(
  "appVqHScGrZ6Soog5"
);

base("Events")
  .select({
    filterByFormula: 'FIND("SJ_MEL_WED_$GH!#", {Event Code})'
  })
  .firstPage()
  .then(data => {
    console.log(data);
...
//   .find("rec9KakNpM358QK0y", function(err, record) {
//     if (err) {
//       console.error(err);
//       return;
//     }
...
// function endError() {
//   $("#rsvp-box").remove();
//   $("#rsvp-title").replaceWith(
//     "<div id='rsvp-title'> <strong> Oh no! Something went wrong. </strong> Please try again or contact us directly if things still don't work. </div>"
//   );
// }
...
//   $("#rsvp-box").remove();
//   $("#rsvp-title").replaceWith(
//     "<div id='rsvp-title'> <strong> You're all set! </strong> Feel free to update your RSVP anytime if plans change. </div>"
//   );
// }
...
//       inputBoxes +=
//         '<div class="field"><input id="input-' +
//         i +
//         '" class="input is-medium" type="text" value="' +
//         previousValues[i - 1] +
//         '" placeholder="Name ' +
//         i +
//         '"></div>';
...
//     $("#rsvp-title").replaceWith(
//       "<strong id='rsvp-title'> Hi " + names + "!</strong>"
//     );
//   } else {
...
//   }
//   $("#rsvp-box").append(
//     '<div id="rsvp-attend" class="animated fadeIn">' +
...
//   selectNumberPeople(
//     "<strong id='rsvp-title'> Welcome back " + names + "!</strong>"
//   );
...
//             $("#help-message").replaceWith(
//               "<p id='help-message' class='help is-danger animated shake'>That email address wasn't found on our list. Please try another email or contact us directly to RSVP.</p>"
//             );
//             return;
//           }
//           if (err) {
...
//     document.getElementById("email-input").classList.add("is-danger");
//     $("#help-message").replaceWith(
//       "<p id='help-message' class='help is-danger animated shake'>Please enter a valid email address</p>"
//     );
//   }
// }
